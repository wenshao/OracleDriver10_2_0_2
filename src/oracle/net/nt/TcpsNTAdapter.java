...
public class TcpsNTAdapter extends TcpNTAdapter
{
  ...
  public void connect()
    throws IOException
  {
    SSLSocketFactory localSSLSocketFactory = CustomSSLSocketFactory.getSSLSocketFactory(this.socketOptions);
    ...
    throws IOException
  {
    ...
    TcpsConfigure.configureVersion(localSSLSocket, (String)this.socketOptions.get(new Integer(6)));
    TcpsConfigure.configureCipherSuites(localSSLSocket, (String)this.socketOptions.get(new Integer(7)));
  }
