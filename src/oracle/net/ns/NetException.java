  ...
  public NetException(int paramInt)
  {
    ...
    try
    {
      if (str.startsWith("1.0"))
        this.message = ((Message)Class.forName("oracle.net.ns.Message10").newInstance());
      else
        this.message = ((Message)Class.forName("oracle.net.ns.Message11").newInstance());
    }
 ...
 * Qualified Name:     oracle.net.ns.NetException
