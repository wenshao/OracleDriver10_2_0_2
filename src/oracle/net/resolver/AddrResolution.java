...
public class AddrResolution
{
    ...
    throws NetException
  {
    ...
    while (i < k)
    {
      for (int j = i + 1; (j < k) && (arrayOfChar[j] != ' '); j++);
    ...
    boolean bool2 = true;
    String str2;
    if (((str2 = this.up.getProperty("oracle.net.ldap_failover")) != null) && ((str2.equalsIgnoreCase("OFF")) || (str2.equalsIgnoreCase("FALSE")) || (str2.equalsIgnoreCase("NO"))))
      bool1 = false;
    if (((str2 = this.up.getProperty("oracle.net.ldap_loadbalance")) != null) && ((str2.equalsIgnoreCase("OFF")) || (str2.equalsIgnoreCase("FALSE")) || (str2.equalsIgnoreCase("NO"))))
      bool2 = false;
    ...
    throws NetException, IOException
  {
    ...
    if (paramString != null)
    {
      ...
      {
        int i;
        if (((i = paramString.indexOf(':')) != -1) && (paramString.indexOf(':', i + 1) != -1))
        {
    ...
    throws NetException
  {
    ...
    try
    {
      ...
      String str = "(DESCRIPTION=(CONNECT_DATA=(SID=" + localConnOption.sid + ")(CID=(PROGRAM=)(HOST=__jdbc__)(USER=)))" + "(ADDRESS=" + "(PROTOCOL=tcp)(HOST=" + localConnOption.host + ")(PORT=" + localConnOption.port + ")))";
    ...
    throws NetException
  {
    ...
    if ((localNVPair2 != null) && (localNVPair2.getListSize() > 0))
      i = 0;
    while (i < localNVPair2.getListSize())
    {
    ...
    if (localNVPair8 != null)
      localStringBuffer.append("(CONNECT_DATA=" + localNVPair8.toString() + "(CID=(PROGRAM=)(HOST=__jdbc__)(USER=)))");
    else
      localStringBuffer.append("(CONNECT_DATA=" + localNVPair6.toString() + "(CID=(PROGRAM=)(HOST=__jdbc__)(USER=)))");
