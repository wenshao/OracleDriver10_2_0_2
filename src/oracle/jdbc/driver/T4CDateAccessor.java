...
/*     */{
	...
	/*     */
	/*     */T4CDateAccessor(OracleStatement paramOracleStatement, int paramInt1,
			short paramShort, int paramInt2, boolean paramBoolean,
			T4CMAREngine paramT4CMAREngine)
	/*     */throws SQLException
	/*     */{
		/* 35 */super(paramOracleStatement, paramInt1, paramShort, paramInt2,
				paramBoolean);
		/*     */
	...
	/*     */throws SQLException
	/*     */{
		/* 48 */super(paramOracleStatement, paramInt1 == -1 ? paramInt8
	...
	/*     */{
		/* 64 */if (((this.internalType == 1) && (this.describeType == 112))
		...
		/*     */{
			...
			/*     */
			/* 80 */if ((this.statement.sqlKind != 1)
					&& (this.statement.sqlKind != 4))
			/*     */{
				/* 82 */this.mare.unmarshalSB2();
				/*     */}
			/* 84 */} else if ((this.statement.sqlKind == 1)
	...
	/*     */{
		...
		/*     */{
			...
			/*     */}
		/*     */
		/* 156 */int k = this.columnIndex + this.lastRowProcessed
				* this.byteLength;
		/*     */
		/* 160 */this.mare.unmarshalCLR(this.rowSpaceByte, k, this.meta,
				this.byteLength);
		/*     */
	...
	/*     */{
		...
		/*     */else {
			...
			/*     */}
		/* 196 */int j = this.columnIndex + this.lastRowProcessed
				* this.byteLength;
		...
		/*     */
		/* 209 */System.arraycopy(this.rowSpaceByte, k, this.rowSpaceByte, j,
				i3);
		/*     */
	...
	/*     */{
		...
		/*     */
		/* 224 */int j = this.columnIndexLastRow + (paramInt1 - 1)
				* this.byteLength;
		/*     */
		...
		/* 236 */if (i2 != 0)
		/*     */{
			/* 238 */System.arraycopy(paramArrayOfByte, j, this.rowSpaceByte,
					i, i2);
			/*     */}
		/*     */}
	...
	/*     */{
		...
		/*     */
		/* 256 */if ((str != null) && (this.definedColumnSize > 0)
	...
	/*     */{
		...
		/*     */{
			...
			case 12:
				...
				/*     */case 91:
				/* 289 */return getDate(paramInt);
				/*     */case 92:
				/* 292 */return getTime(paramInt);
				/*     */case 93:
				/* 295 */return getTimestamp(paramInt);
				/*     */case -4:
				/*     */
			case -3:
				/*     */
 ...
 * /jdbc.oracle-10.2.0.2.jar Qualified Name: oracle.jdbc.driver.T4CDateAccessor
