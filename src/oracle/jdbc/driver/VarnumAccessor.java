...
/*    */{
	/*    */VarnumAccessor(OracleStatement paramOracleStatement, int paramInt1,
			short paramShort, int paramInt2, boolean paramBoolean)
	/*    */throws SQLException
	/*    */{
		/* 18 */init(paramOracleStatement, paramInt1, paramShort, paramInt2,
				paramBoolean);
		/*    */}
	...
	/*    */throws SQLException
	/*    */{
		/* 29 */init(paramOracleStatement, 6, paramInt1, paramBoolean,
 ...
 * /jdbc.oracle-10.2.0.2.jar Qualified Name: oracle.jdbc.driver.VarnumAccessor
