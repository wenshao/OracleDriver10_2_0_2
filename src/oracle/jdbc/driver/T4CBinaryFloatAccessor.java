...
/*     */       case 4:
/* 290 */         return new Integer(getInt(paramInt));
/*     */       case -6:
/* 293 */         return new Byte(getByte(paramInt));
/*     */       case 5:
/* 296 */         return new Short(getShort(paramInt));
/*     */       case 6:
/*     */       case 8:
/* 301 */         return new Double(getDouble(paramInt));
/*     */       case 2:
/*     */       case 3:
/* 306 */         return getBigDecimal(paramInt);
/*     */       case 7:
/* 309 */         return new Float(getFloat(paramInt));
/*     */       case 100:
/* 312 */         return getBINARY_FLOAT(paramInt);
/*     */       case -5:
/* 315 */         return new Long(getLong(paramInt));
/*     */       case -4:
/*     */       case -3:
/*     */       case -2:
